...
/*
    // KE: numeric crashes on SVD
    // numericjs implementation is likely culprit
    // https://groups.google.com/forum/#!topic/numericjs/uBK5qOmLAMs
    msvd = numeric.svd(m);
    return numeric.dot(msvd.V,numeric.dot(numeric.inv(msvd.S),numeric.transpose(msvd.U)));
*/
